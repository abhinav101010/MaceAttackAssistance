 ...
 *  net.minecraft.KeyBinding$Category
 *  net.minecraft.InputUtil$Type
 */
...
public class Config {
    public static final Identifier CROSSHAIR_TEXTURE = Identifier.ofVanilla((String)"hud/crosshair");
    public static final Identifier CUSTOM_CROSSHAIR_TEXTURE = Identifier.of((String)"maceattackassistance", (String)"hud/custom_crosshair");
    ...
    public static final KeyBinding.Category KEY_CATEGORY_MACE_ATTACK_ASSISTANCE = KeyBinding.Category.create((Identifier)Identifier.of((String)"maceattackassistance", (String)"main"));
    ...
    public static final String KEY_DESC_PEARL_CATCH = "key.desc.pearl_catch";
    ...
    public static boolean SPEAR_SLAM;
    public static int SPEAR_SLAM_MIN_FALL;
    public static int SPEAR_SLAM_COOLDOWN;
    public static int SPEAR_SLAM_DAMAGE_MULT_INT;
    public static boolean SPEAR_SLAM_PARTICLES;
    public static boolean SPEAR_SLAM_SOUND;
    ...
    public static boolean PEARL_CATCH;
    public static int PEARL_CATCH_DELAY;
    public static int PEARL_CATCH_RANGE;
    ...
    public static KeyBinding BREACH_SWAP_SETTING_KEY;
    public static KeyBinding BULK_REFILL_KEY;
    public static KeyBinding CONFIG_SCREEN_KEY;
    public static KeyBinding DOUBLE_TAP_SETTING_KEY;
    ...
    public static KeyBinding REWEAR_SETTING_KEY;
    public static KeyBinding SEARCH_SETTING_KEY;
    public static KeyBinding TOGGLE_ELYTRA_KEY;
    public static KeyBinding TOGGLE_JUMP_MODE_KEY;
    public static KeyBinding ZOOM_CAMERA_KEY;
    public static KeyBinding ELYTRA_BOOST_SETTING_KEY;
    public static KeyBinding RETURN_TO_PREV_SLOT_BREACH_SETTING_KEY;
    public static KeyBinding AUTO_WIND_CHARGE_SELECT_SETTING_KEY;
    public static KeyBinding SHIELD_DRAINING_SETTING_KEY;
    public static KeyBinding FRIEND_PROTECTION_SETTING_KEY;
    public static KeyBinding TOGGLE_BREACH_SWAP_MODE_KEY;
    public static KeyBinding TOGGLE_SWORD_OR_AXE_KEY;
    public static KeyBinding SPEAR_LUNGE;
    public static KeyBinding PEARL_CATCH_KEY;
    ...
    public static void initialize() {
        ...
        BREACH_SWAP_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_TOGGLE_BREACH, InputUtil.Type.KEYSYM, 79, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        DOUBLE_TAP_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_TOGGLE_DOUBLE_TAP, InputUtil.Type.KEYSYM, 80, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        TOGGLE_JUMP_MODE_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_TOGGLE_JUMP_MODE, InputUtil.Type.KEYSYM, 74, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        REWEAR_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_TOGGLE_REWEAR, InputUtil.Type.KEYSYM, 77, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        ELYTRA_BOOST_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_ELYTRA_BOOST, InputUtil.Type.KEYSYM, 85, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        RETURN_TO_PREV_SLOT_BREACH_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_RETURN_TO_PREV_SLOT_BREACH, InputUtil.Type.KEYSYM, 89, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        AUTO_WIND_CHARGE_SELECT_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_AUTO_WIND_CHARGE_SELECT, InputUtil.Type.KEYSYM, 72, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        SHIELD_DRAINING_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_SHIELD_DRAINING, InputUtil.Type.KEYSYM, 71, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        FRIEND_PROTECTION_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_FRIEND, InputUtil.Type.KEYSYM, 84, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        TOGGLE_BREACH_SWAP_MODE_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_BREACH_SWAP_MODE, InputUtil.Type.KEYSYM, 44, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        TOGGLE_SWORD_OR_AXE_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_SWORD_OR_AXE, InputUtil.Type.KEYSYM, 46, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        SPEAR_LUNGE = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_SPEAR_LUNGE, InputUtil.Type.KEYSYM, 59, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        PEARL_CATCH_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_PEARL_CATCH, InputUtil.Type.KEYSYM, 70, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
    }

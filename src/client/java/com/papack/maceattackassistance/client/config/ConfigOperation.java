...
public class ConfigOperation {
    ...
    public static final ConfigData PROP_ONE_TICK_STUN = new ConfigData("OneTickStunSlam", "false", Type.B);
    public static final ConfigData PROP_FORCED_DISABLE = new ConfigData("ForcedDisable", "false", Type.B);
    ...
    public static final ConfigData PROP_DT_AERIAL_DIVE_MODE = new ConfigData("AerialDiveMode", "false", Type.B);
    ...
    public static final ConfigData PROP_STUN_ADJUSTMENT = new ConfigData("StunSlamAdjustment", "0", Type.I);
    ...
    public static final ConfigData PROP_AUTO_SHIELD_DRAINING = new ConfigData("AutoShieldDraining", "true", Type.B);
    public static final ConfigData PROP_INSTANT_SHIELD_DRAINING = new ConfigData("InstantShieldDraining", "false", Type.B);
    ...
    public static final ConfigData PROP_AIM_FORCED_ADJUSTMENT = new ConfigData("ForcedAdjustment", "true", Type.B);
    ...
    public static final ConfigData PROP_AIM_ELYTRA = new ConfigData("AimElytra", "false", Type.B);
    ...
    public static final ConfigData PROP_ROCKET_BLITZ_CAN_EMPTY_SLOT = new ConfigData("RocketBlitzCanBeUsedEmptySlot", "true", Type.B);
    public static final ConfigData PROP_ROCKET_TRIGGER = new ConfigData("RocketTrigger", "SPACE", Type.E);
    public static final ConfigData PROP_ROCKET_TRIGGER_SPEAR = new ConfigData("RocketTriggerSpear", "L_CTRL", Type.E);
    ...
    public static final ConfigData PROP_ELYTRA_MANUAL_MODE = new ConfigData("ElytraManualMode", "true", Type.B);
    ...
    public static final ConfigData PROP_LUNGE_EXECUTION_SLOT = new ConfigData("LungeExecutionSlot", "-1", Type.I);
    public static final ConfigData PROP_KEEP_AFTER_EXECUTION = new ConfigData("KeepAfterExecution", "false", Type.B);
    public static final ConfigData PROP_FORCED_EXECUTION_SLOT = new ConfigData("ForcedExecutionSlot", "false", Type.B);
    public static final ConfigData PROP_TARGET_MARKER = new ConfigData("TargetMarker", "false", Type.B);
    ...
    public static final ConfigData PROP_KBD_RANGE = new ConfigData("KBDRange", "8", Type.I);
    public static final ConfigData PROP_KBD_INSTANT_AIM = new ConfigData("KBDInstantAim", "true", Type.B);
    public static final ConfigData PROP_KBD_AUTO_FLICK = new ConfigData("KBDAutoFlick", "true", Type.B);
    public static final ConfigData PROP_KBD_FLICK_ANGLE = new ConfigData("KBDFlickAngle", "60", Type.I);
    public static final ConfigData PROP_AUTO_LEFT_CLICK = new ConfigData("AutoLeftClick", "true", Type.B);
    public static final ConfigData PROP_PEARL_CATCH_MODE = new ConfigData("PearlCatchMode", "true", Type.B);
    public static final ConfigData PROP_PEARL_CATCH_ADJUST = new ConfigData("PearlCatchAdjust", "true", Type.B);
    public static final ConfigData PROP_PEARL_CATCH_DELAY = new ConfigData("PearlCatchDelay", "0", Type.I);
    public static final ConfigData PROP_PEARL_CATCH_UPWARD_ANGLE = new ConfigData("PearlCatchUpwardAngle", "-45", Type.I);
    public static final ConfigData PROP_PEARL_CATCH_DOWNWARD_ANGLE = new ConfigData("PearlCatchDownwardAngle", "90", Type.I);
    public static final ConfigData PROP_ALWAYS_USE_UPWARD_ANGLE = new ConfigData("AlwaysUseUpwardAngle", "false", Type.B);
    public static final ConfigData PROP_ALWAYS_USE_DOWNWARD_ANGLE = new ConfigData("AlwaysUseDownwardAngle", "false", Type.B);
    ...
    public static final ConfigData PROP_PREV_SLOT_DELAY = new ConfigData("PrevSlotDelay", "0", Type.I);
    ...
    public static final ConfigData PROP_ATTACK_RANGE = new ConfigData("AttackRange", "31", Type.I);
    public static final ConfigData PROP_ATTACK_RANGE_STUN = new ConfigData("AttackRangeStun", "31", Type.I);
    public static final ConfigData PROP_ATTACK_RANGE_SPEAR = new ConfigData("AttackRangeSpear", "50", Type.I);
    ...
    public static final ConfigData PROP_DEFAULT_EXPANDED_SUB = new ConfigData("DefaultExpandedSUB", "true", Type.B);
    public static final ConfigData PROP_DEFAULT_EXPANDED_GLOBAL = new ConfigData("DefaultExpandedGLOBAL", "false", Type.B);
    private static final List<ConfigData> configList = new ArrayList<ConfigData>(Arrays.asList(PROP_AIM_ASSIST, PROP_AIM_ELYTRA, PROP_AIM_FALL_THRESHOLD, PROP_AIM_FORCED_ADJUSTMENT, PROP_AIM_MODE, PROP_AIM_RAYCAST, PROP_AIM_RAYCAST_RADIUS, PROP_AIM_RAYCAST_RANGE, PROP_ALLOWED_AMBIENT, PROP_ALLOWED_HOSTILE, PROP_ALLOWED_IRON_GOLEM, PROP_ALLOWED_PASSIVE, PROP_ALLOWED_PLAYER, PROP_ALLOWED_VILLAGER, PROP_ALSO_SEARCH_INVENTORY, PROP_ATTACK_ASSISTANCE, PROP_ATTACK_DISTANCE[0], PROP_ATTACK_DISTANCE[1], PROP_ATTACK_DISTANCE[2], PROP_ATTACK_DISTANCE[3], PROP_ATTACK_MODE, PROP_ATTACK_RANGE, PROP_ATTACK_RANGE_STUN, PROP_ATTACK_RANGE_SPEAR, PROP_AUTO_ELYTRA, PROP_AUTO_ELYTRA_DISTANCE, PROP_AUTO_ELYTRA_DISTANCE_NORMAL, PROP_AUTO_ELYTRA_TICK_AHEAD, PROP_AUTO_ELYTRA_TICK_AHEAD_NORMAL, PROP_AUTO_LEFT_CLICK, PROP_AUTO_MODE_THRESHOLD, PROP_AUTO_REFILL, PROP_AUTO_SHIELD_DRAINING, PROP_AUTO_WIND_CHARGE_SELECT, PROP_AXE_SLOT, PROP_BASE_RADIUS, PROP_BEHAVIOR_NOT_WEARING_ARMOR, PROP_BREACH_LIMITED, PROP_BREACH_ON_GROUND, PROP_BREACH_SWAP, PROP_CAMERA_RETURN_BEHAVIOR, PROP_COILS, PROP_COLOR_AMBIENT, PROP_COLOR_HOSTILE, PROP_COLOR_IRON_GOLEM, PROP_COLOR_PASSIVE, PROP_COLOR_PLAYER, PROP_COLOR_VILLAGER, PROP_COLOR_WARDEN, PROP_COOL_DOWN_TICKS, PROP_CROSSHAIR_MODE, PROP_DEBUG_LANDING_POS, PROP_DEFAULT_EXPANDED_GLOBAL, PROP_DEFAULT_EXPANDED_SUB, PROP_DISPLAY_ACTION_BAR, PROP_DOUBLE_TAP, PROP_DOUBLE_TAP_REWEAR, PROP_DOUBLE_TAP_REWEAR_DELAY, PROP_DT_AERIAL_DIVE_MODE, PROP_ELYTRA_BOOST, PROP_ELYTRA_MANUAL_MODE, PROP_EXTREME, PROP_FALL_VELOCITY[0], PROP_FALL_VELOCITY[1], PROP_FALL_VELOCITY[2], PROP_FALL_VELOCITY[3], PROP_FLAP_SUPPRESSION, PROP_FLAP_SUPPRESSION_THRESHOLD, PROP_FLAP_SUPPRESSION_TICK, PROP_FORCED_DISABLE, PROP_FORCED_EXECUTION_SLOT, PROP_FOV_HORIZONTAL, PROP_FOV_HORIZONTAL_ON_ZOOM, PROP_FOV_SUPPRESSION, PROP_FOV_VERTICAL, PROP_FOV_VERTICAL_ON_ZOOM, PROP_FRIEND_MARK, PROP_FRIEND_NOT_FOUND, PROP_FRIEND_PROTECTION, PROP_HEIGHT, PROP_HEIGHT_THRESHOLD, PROP_HIDE_MARKER, PROP_HOT_SWAP, PROP_IN_USE_ELYTRA_JUMP_MODE, PROP_INSTANT_SHIELD_DRAINING, PROP_JUMP_ASSIST, PROP_JUMP_SPAM, PROP_JUMP_SPAM_THRESHOLD, PROP_JUMP_SPAM_TICK, PROP_KBD_AUTO_FLICK, PROP_KBD_FLICK_ANGLE, PROP_KBD_INSTANT_AIM, PROP_KBD_RANGE, PROP_KEEP_AFTER_EXECUTION, PROP_LEGACY_AIM_MODE, PROP_LUNGE_EXECUTION_SLOT, PROP_MACE_BREACH, PROP_MACE_PARTICLE, PROP_MACE_PRIMARY, PROP_MANUAL_CAMERA_PITCH, PROP_MANUAL_INCIDENCE_TICK, PROP_MARKER_OFFSET, PROP_MARKER_TYPE, PROP_MAX_SPEED_YAW, PROP_NOT_USE_ELYTRA_JUMP_MODE, PROP_ONE_TICK_STUN, PROP_PARALLEL_SEARCH, PROP_PARTICLE_ORDER, PROP_PARTICLE_TRANSITION_THRESHOLD, PROP_PEARL_CATCH_ADJUST, PROP_PEARL_CATCH_DELAY, PROP_PEARL_CATCH_DOWNWARD_ANGLE, PROP_PEARL_CATCH_UPWARD_ANGLE, PROP_ALWAYS_USE_UPWARD_ANGLE, PROP_ALWAYS_USE_DOWNWARD_ANGLE, PROP_PEARL_CATCH_MODE, PROP_PERSPECTIVE_BACK_CROSSHAIR, PROP_PREV_SLOT_DELAY, PROP_PRIORITIZE_ROCKET, PROP_PRIORITIZE_WIND_CHARGE, PROP_RADAR_DOWNWARD, PROP_RADAR_HORIZONTAL, PROP_RADAR_UPDATE_INTERVAL, PROP_RADAR_UPWARD, PROP_RECON_QUICK_ATTACK, PROP_RECON_QUICK_ZOOM, PROP_REFLECTION_ANGLE, PROP_RETURN_TO_PREV_SLOT, PROP_RETURN_TO_PREV_SLOT_BREACH, PROP_RETURN_TO_PREV_SLOT_MODE, PROP_ROCKET_BLITZ, PROP_ROCKET_BLITZ_SLOT, PROP_ROCKET_BLITZ_CAN_EMPTY_SLOT, PROP_ROCKET_TRIGGER, PROP_ROCKET_TRIGGER_SPEAR, PROP_SIZE, PROP_SNAPBACK, PROP_SNAPBACK_THRESHOLD, PROP_SNAPBACK_TOLERANCE, PROP_SNAPBACK_Y_OFFSET, PROP_SPEAR_ASSIST, PROP_SPEED, PROP_SPIRAL_ALPHA, PROP_SPIRAL_COUNT, PROP_SPIRAL_GAMMA, PROP_SPIRAL_LENGTH, PROP_STUN_ADJUSTMENT, PROP_STUN_HIGH, PROP_STUN_LOW, PROP_STUN_SLAMMING, PROP_SWING_TOGGLE, PROP_SWORD_OR_AXE, PROP_SWORD_SWAP_OR_BREACH_SWAP, PROP_TARGET_MARKER, PROP_TARGET_SEARCH_MODE, PROP_TOGGLE_JUMP_MODE, PROP_TOGGLE_SLOT, PROP_WALL_CLIMBING, PROP_WAVE_AMPLITUDE, PROP_WAVE_SPEED, PROP_WEAPON_SWING, PROP_ZOOM_STEP, PROP_ZOOM_VIEW));
    ...
    public static void loadFile() {
        ...
        try {
            ...
            MaceAttackAssistanceClient.LOGGER.info("load input stream completed");
        }
        catch (IOException e) {
            MaceAttackAssistanceClient.LOGGER.error("load input stream failed");
            throw new RuntimeException(e);
        }
        try {
            ...
            Config.ONE_TICK_STUN_SLAM = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_ONE_TICK_STUN.label, ConfigOperation.PROP_ONE_TICK_STUN.defaultValue));
            Config.FORCED_DISABLE = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_FORCED_DISABLE.label, ConfigOperation.PROP_FORCED_DISABLE.defaultValue));
            ...
            Config.DT_AERIAL_DIVE_MODE = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_DT_AERIAL_DIVE_MODE.label, ConfigOperation.PROP_DT_AERIAL_DIVE_MODE.defaultValue));
            ...
            Config.ROCKET_BLITZ_CAN_EMPTY_SLOT = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_ROCKET_BLITZ_CAN_EMPTY_SLOT.label, ConfigOperation.PROP_ROCKET_BLITZ_CAN_EMPTY_SLOT.defaultValue));
            ...
            Config.ROCKET_TRIGGER_SPEAR = Config.RocketTrigger.valueOf(properties.getProperty(ConfigOperation.PROP_ROCKET_TRIGGER_SPEAR.label, ConfigOperation.PROP_ROCKET_TRIGGER_SPEAR.defaultValue));
            ...
            Config.STUN_ADJUSTMENT = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_STUN_ADJUSTMENT.label, ConfigOperation.PROP_STUN_ADJUSTMENT.defaultValue));
            ...
            Config.AIM_ELYTRA = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_AIM_ELYTRA.label, ConfigOperation.PROP_AIM_ELYTRA.defaultValue));
            ...
            Config.ATTACK_RANGE_STUN = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_ATTACK_RANGE_STUN.label, ConfigOperation.PROP_ATTACK_RANGE_STUN.defaultValue));
            Config.ATTACK_RANGE_SPEAR = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_ATTACK_RANGE_SPEAR.label, ConfigOperation.PROP_ATTACK_RANGE_SPEAR.defaultValue));
            ...
            Config.AUTO_SHIELD_DRAINING = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_AUTO_SHIELD_DRAINING.label, ConfigOperation.PROP_AUTO_SHIELD_DRAINING.defaultValue));
            Config.INSTANT_SHIELD_DRAINING = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_INSTANT_SHIELD_DRAINING.label, ConfigOperation.PROP_INSTANT_SHIELD_DRAINING.defaultValue));
            ...
            Config.PEARL_CATCH_MODE = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_PEARL_CATCH_MODE.label, ConfigOperation.PROP_PEARL_CATCH_MODE.defaultValue));
            Config.PEARL_CATCH_ADJUST = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_PEARL_CATCH_ADJUST.label, ConfigOperation.PROP_PEARL_CATCH_ADJUST.defaultValue));
            Config.PEARL_CATCH_DELAY = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_PEARL_CATCH_DELAY.label, ConfigOperation.PROP_PEARL_CATCH_DELAY.defaultValue));
            Config.PEARL_CATCH_UPWARD_ANGLE = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_PEARL_CATCH_UPWARD_ANGLE.label, ConfigOperation.PROP_PEARL_CATCH_UPWARD_ANGLE.defaultValue));
            Config.PEARL_CATCH_DOWNWARD_ANGLE = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_PEARL_CATCH_DOWNWARD_ANGLE.label, ConfigOperation.PROP_PEARL_CATCH_DOWNWARD_ANGLE.defaultValue));
            Config.ALWAYS_USE_UPWARD_ANGLE = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_ALWAYS_USE_UPWARD_ANGLE.label, ConfigOperation.PROP_ALWAYS_USE_UPWARD_ANGLE.defaultValue));
            Config.ALWAYS_USE_DOWNWARD_ANGLE = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_ALWAYS_USE_DOWNWARD_ANGLE.label, ConfigOperation.PROP_ALWAYS_USE_DOWNWARD_ANGLE.defaultValue));
            Config.PREV_SLOT_DELAY = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_PREV_SLOT_DELAY.label, ConfigOperation.PROP_PREV_SLOT_DELAY.defaultValue));
            Config.LUNGE_EXECUTION_SLOT = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_LUNGE_EXECUTION_SLOT.label, ConfigOperation.PROP_LUNGE_EXECUTION_SLOT.defaultValue));
            Config.KEEP_AFTER_EXECUTION = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_KEEP_AFTER_EXECUTION.label, ConfigOperation.PROP_KEEP_AFTER_EXECUTION.defaultValue));
            Config.FORCED_EXECUTION_SLOT = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_FORCED_EXECUTION_SLOT.label, ConfigOperation.PROP_FORCED_EXECUTION_SLOT.defaultValue));
            ...
            Config.KBD_RANGE = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_KBD_RANGE.label, ConfigOperation.PROP_KBD_RANGE.defaultValue));
            Config.KBD_INSTANT_AIM = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_KBD_INSTANT_AIM.label, ConfigOperation.PROP_KBD_INSTANT_AIM.defaultValue));
            Config.KBD_AUTO_FLICK = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_KBD_AUTO_FLICK.label, ConfigOperation.PROP_KBD_AUTO_FLICK.defaultValue));
            Config.KBD_FLICK_ANGLE = Integer.parseInt(properties.getProperty(ConfigOperation.PROP_KBD_FLICK_ANGLE.label, ConfigOperation.PROP_KBD_FLICK_ANGLE.defaultValue));
            Config.AUTO_LEFT_CLICK = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_AUTO_LEFT_CLICK.label, ConfigOperation.PROP_AUTO_LEFT_CLICK.defaultValue));
            Config.DEFAULT_EXPANDED_SUB = Boolean.parseBoolean(properties.getProperty(ConfigOperation.PROP_DEFAULT_EXPANDED_SUB.label, ConfigOperation.PROP_DEFAULT_EXPANDED_SUB.defaultValue));
            ...
            MaceAttackAssistanceClient.LOGGER.error("set config : failed");
            MaceAttackAssistanceClient.LOGGER.error((Object)e);
        }
    }
    ...
    public static void saveFile() {
        ...
        try {
            ...
            properties.setProperty(ConfigOperation.PROP_ONE_TICK_STUN.label, String.valueOf(Config.ONE_TICK_STUN_SLAM));
            properties.setProperty(ConfigOperation.PROP_FORCED_DISABLE.label, String.valueOf(Config.FORCED_DISABLE));
            ...
            properties.setProperty(ConfigOperation.PROP_DT_AERIAL_DIVE_MODE.label, String.valueOf(Config.DT_AERIAL_DIVE_MODE));
            ...
            properties.setProperty(ConfigOperation.PROP_ROCKET_BLITZ_CAN_EMPTY_SLOT.label, String.valueOf(Config.ROCKET_BLITZ_CAN_EMPTY_SLOT));
            ...
            properties.setProperty(ConfigOperation.PROP_ROCKET_TRIGGER_SPEAR.label, String.valueOf((Object)Config.ROCKET_TRIGGER_SPEAR));
            ...
            properties.setProperty(ConfigOperation.PROP_STUN_ADJUSTMENT.label, String.valueOf(Config.STUN_ADJUSTMENT));
            ...
            properties.setProperty(ConfigOperation.PROP_AIM_ELYTRA.label, String.valueOf(Config.AIM_ELYTRA));
            ...
            properties.setProperty(ConfigOperation.PROP_ATTACK_RANGE_STUN.label, String.valueOf(Config.ATTACK_RANGE_STUN));
            properties.setProperty(ConfigOperation.PROP_ATTACK_RANGE_SPEAR.label, String.valueOf(Config.ATTACK_RANGE_SPEAR));
            ...
            properties.setProperty(ConfigOperation.PROP_AUTO_SHIELD_DRAINING.label, String.valueOf(Config.AUTO_SHIELD_DRAINING));
            properties.setProperty(ConfigOperation.PROP_INSTANT_SHIELD_DRAINING.label, String.valueOf(Config.INSTANT_SHIELD_DRAINING));
            properties.setProperty(ConfigOperation.PROP_PEARL_CATCH_MODE.label, String.valueOf(Config.PEARL_CATCH_MODE));
            properties.setProperty(ConfigOperation.PROP_PEARL_CATCH_ADJUST.label, String.valueOf(Config.PEARL_CATCH_ADJUST));
            properties.setProperty(ConfigOperation.PROP_PEARL_CATCH_DELAY.label, String.valueOf(Config.PEARL_CATCH_DELAY));
            properties.setProperty(ConfigOperation.PROP_PEARL_CATCH_UPWARD_ANGLE.label, String.valueOf(Config.PEARL_CATCH_UPWARD_ANGLE));
            properties.setProperty(ConfigOperation.PROP_PEARL_CATCH_DOWNWARD_ANGLE.label, String.valueOf(Config.PEARL_CATCH_DOWNWARD_ANGLE));
            properties.setProperty(ConfigOperation.PROP_ALWAYS_USE_UPWARD_ANGLE.label, String.valueOf(Config.ALWAYS_USE_UPWARD_ANGLE));
            properties.setProperty(ConfigOperation.PROP_ALWAYS_USE_DOWNWARD_ANGLE.label, String.valueOf(Config.ALWAYS_USE_DOWNWARD_ANGLE));
            properties.setProperty(ConfigOperation.PROP_PREV_SLOT_DELAY.label, String.valueOf(Config.PREV_SLOT_DELAY));
            properties.setProperty(ConfigOperation.PROP_LUNGE_EXECUTION_SLOT.label, String.valueOf(Config.LUNGE_EXECUTION_SLOT));
            properties.setProperty(ConfigOperation.PROP_KEEP_AFTER_EXECUTION.label, String.valueOf(Config.KEEP_AFTER_EXECUTION));
            properties.setProperty(ConfigOperation.PROP_FORCED_EXECUTION_SLOT.label, String.valueOf(Config.FORCED_EXECUTION_SLOT));
            ...
            properties.setProperty(ConfigOperation.PROP_KBD_RANGE.label, String.valueOf(Config.KBD_RANGE));
            properties.setProperty(ConfigOperation.PROP_KBD_INSTANT_AIM.label, String.valueOf(Config.KBD_INSTANT_AIM));
            properties.setProperty(ConfigOperation.PROP_KBD_AUTO_FLICK.label, String.valueOf(Config.KBD_AUTO_FLICK));
            properties.setProperty(ConfigOperation.PROP_KBD_FLICK_ANGLE.label, String.valueOf(Config.KBD_FLICK_ANGLE));
            properties.setProperty(ConfigOperation.PROP_AUTO_LEFT_CLICK.label, String.valueOf(Config.AUTO_LEFT_CLICK));
            properties.setProperty(ConfigOperation.PROP_DEFAULT_EXPANDED_SUB.label, String.valueOf(Config.DEFAULT_EXPANDED_SUB));

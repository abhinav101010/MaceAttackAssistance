...
public class SwitchAssist {
    ...
    public static void displayMessage(String msg) {
        ...
        MutableComponent text = Component.literal((String)msg);
        if (player != null && Config.DISPLAY_ACTION_BAR != Config.DisplayAt.Off) {
            ...
            MutableComponent mutableComponent = message = flag ? text.withStyle(ChatFormatting.BOLD) : text;
            if (flag) {
                Minecraft.getInstance().gui.hud.getChat().addClientSystemMessage((Component)message.withStyle(ChatFormatting.GREEN));
            } else {
                Minecraft.getInstance().gui.hud.getChat().addClientSystemMessage((Component)message.withStyle(ChatFormatting.GREEN));
            }
        }

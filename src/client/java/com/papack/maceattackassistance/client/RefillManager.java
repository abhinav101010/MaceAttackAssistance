    ...
    public static void tick(Minecraft client, LocalPlayer player) {
        ...
        if (RefillManager.condition(client)) {
            ...
            if (refillData != null && manager != null) {
                ...
                boolean isTargetItem = refillData.item.equals(player.getInventory().getItem(Utils.isHotBar(slot) ? slot : 40).getItem());
                if (isTargetItem) {
                ...
                if (!(isTargetItemAfterRefill = refillData.item.equals(player.getInventory().getItem(Utils.isHotBar(slot) ? slot : 40).getItem())) && AutoRefill.checkStockQuantity(player, refillData.item())) {

...
public class TickScheduler {
    ...
    public static void init() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            Object object;
            List<ScheduledTask> scheduledList = scheduledTasksToAdd;
            synchronized (scheduledList) {
                scheduledTasks.addAll(scheduledTasksToAdd);
                scheduledTasksToAdd.clear();
            }
            List<ConditionTask> conditionList = conditionTasksToAdd;
            ...
            List<ScheduledTask> activeScheduledList = scheduledTasks;
            synchronized (activeScheduledList) {

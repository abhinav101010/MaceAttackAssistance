...
public class Config {
    ...
    public static void initialize() {
        KeyBinding.Category category = KeyBinding.Category.create(Identifier.of(KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        ATTACK_SETTING_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_ATTACK, 295, category));
        AIM_SETTING_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_AIM, 296, category));
        CONFIG_SCREEN_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_CONFIG, 73, category));
        TOGGLE_ELYTRA_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_TOGGLE_ELYTRA, 82, category));
        ENDER_PEARL_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_ENDER_PEARL, 90, category));
        BULK_REFILL_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_BULK_REFILL, 86, category));
        ZOOM_CAMERA_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_ZOOM_CAMERA, 78, category));
        JUMP_SETTING_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_JUMP, 75, category));
        SEARCH_SETTING_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_SEARCH, 76, category));
        RETURN_TO_PREV_SLOT_SETTING_KEY = KeyBindingHelper.registerKeyBinding(new KeyBinding(KEY_DESC_RETURN_TO_PREV_SLOT, 66, category));
    }

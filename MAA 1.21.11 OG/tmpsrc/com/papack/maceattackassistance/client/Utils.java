...
public class Utils {
    ...
    public static boolean isNotUsingElytra(ClientPlayerEntity clientPlayer) {
        return !clientPlayer.isFallFlying() || !(clientPlayer.getEquippedStack(EquipmentSlot.CHEST).getItem() instanceof ElytraItem);
    }
    ...
    public static boolean isOnSlimeBlock(ClientPlayerEntity clientPlayer) {
        ...
        BlockState state = clientPlayer.getWorld().getBlockState(pos);
    ...
    public static Vec3d getTargetPos(Entity target, boolean eyePos) {
        ...
        if (target instanceof EnderDragonEntity) {
            ...
            VanillaChestLootTableGenerator = eyePos ? target.getEyePos() : target.getPos();
        }

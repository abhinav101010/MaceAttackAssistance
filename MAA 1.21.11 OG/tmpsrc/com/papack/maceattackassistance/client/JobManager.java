...
public class JobManager {
    ...
    private static InputUtil.class_306 attackKey;
    private static InputUtil.class_306 axeKey;
    private static InputUtil.class_306 maceKey;
    ...
    private static void returnToPreviousSlot(MinecraftClient client) {
        if (previousSlot > -1 && previousSlot != 9) {
            KeyBinding.onKeyPressed((InputUtil.class_306)((KeyBindingInvoker)client.options.hotbarKeys[previousSlot]).accessorBoundKey());
        }
        previousSlot = -1;
        beforeAxeSlot = -1;
    }
    ...
    public static void airBreach(int value) {
        switch (value) {
            case 4: {
                KeyBinding.onKeyPressed((InputUtil.class_306)maceKey);
                break;
            }
            case 2: {
                JobManager.attack();
    ...
    public static void highSpeed(int value) {
        switch (value) {
            case 5: {
                KeyBinding.onKeyPressed((InputUtil.class_306)maceKey);
                KeyBinding.onKeyPressed((InputUtil.class_306)attackKey);
                break;
            }
            case 2: {
                JobManager.setLock(1);
    ...
    public static void airShieldBreach(int value) {
        switch (value) {
            case 5: {
                KeyBinding.onKeyPressed((InputUtil.class_306)axeKey);
                break;
            }
            case 4: {
                JobManager.attack();
            ...
            switch (value) {
                case 5: {
                    ...
                    if (JobManager.enderPearlData.canThrow) {
                        KeyBinding.onKeyPressed((InputUtil.class_306)((KeyBindingInvoker)client.options.hotbarKeys[JobManager.enderPearlData.newSlot]).accessorBoundKey());
                        break;
                    }
                    value = 1;
                    break;
                ...
                case 3: {
                    KeyBinding.onKeyPressed((InputUtil.class_306)((KeyBindingInvoker)client.options.useKey).accessorBoundKey());
    ...
    public static void elytraBoost(int value) {
        ...
        if (clientPlayer != null) {
            if (value == BOOST_THROW && !ElytraBoost.flag_elytra_boost) {
                ...
                KeyBinding.onKeyPressed((InputUtil.class_306)((KeyBindingInvoker)JobManager.client.options.useKey).accessorBoundKey());
            }
            if (value == BOOST_JUMP) {

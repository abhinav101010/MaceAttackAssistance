...
public class HotSwap {
    ...
    private static boolean isBreachMace(ClientPlayerEntity clientPlayer, ItemStack itemStack) {
        ...
        return HotSwap.hasBreachEnchantment(clientPlayer.getWorld(), itemStack) > 0;
    }

    public static int hasBreachEnchantment(World world, ItemStack itemStack) {
        RegistryEntry.class_6883 enchantment;
        if (world != null && itemStack != null && (enchantment = world.getRegistryManager().get(RegistryKeys.ENCHANTMENT).entryOf(Enchantments.BREACH)) != null) {

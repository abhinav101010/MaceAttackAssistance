...
public class Config {
    ...
    public static void initialize() {
        ATTACK_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_ATTACK, InputUtil.class_307.KEYSYM, 295, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        AIM_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_AIM, InputUtil.class_307.KEYSYM, 296, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        CONFIG_SCREEN_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_CONFIG, InputUtil.class_307.KEYSYM, 73, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        TOGGLE_ELYTRA_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_TOGGLE_ELYTRA, InputUtil.class_307.KEYSYM, 82, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        ENDER_PEARL_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_ENDER_PEARL, InputUtil.class_307.KEYSYM, 90, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        BULK_REFILL_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_BULK_REFILL, InputUtil.class_307.KEYSYM, 86, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        ZOOM_CAMERA_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_ZOOM_CAMERA, InputUtil.class_307.KEYSYM, 78, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        JUMP_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_JUMP, InputUtil.class_307.KEYSYM, 75, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        SEARCH_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_SEARCH, InputUtil.class_307.KEYSYM, 76, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
        RETURN_TO_PREV_SLOT_SETTING_KEY = KeyBindingHelper.registerKeyBinding((KeyBinding)new KeyBinding(KEY_DESC_RETURN_TO_PREV_SLOT, InputUtil.class_307.KEYSYM, 66, KEY_CATEGORY_MACE_ATTACK_ASSISTANCE));
    }
